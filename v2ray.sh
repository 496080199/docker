...
TAG=$(wget -qO- https://raw.githubusercontent.com/496080199/docker/master/ReleaseTag | head -n1)
wget -O ${PWD}/v2ray.zip https://github.com/v2fly/v2ray-core/releases/download/${TAG}/${V2RAY_FILE}
wget -O ${PWD}/v2ray.zip.dgst https://github.com/v2fly/v2ray-core/releases/download/${TAG}/${DGST_FILE}
